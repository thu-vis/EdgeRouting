! function() {
		...
		function r(n) {
			...
			return {
				...
				point: function(f, h) {
					...
					if (!r && (s = c = v) && n.lineStart(), v !== c && (g = e(r, p), (_r(r, g) || _r(p, g)) && (p[0] += Ca, p[1] += Ca, v = t(p[0], p[1]))), v !== c) l = 0, v ? (n.lineStart(), g = e(p, r), n.point(g[0], g[1])) : (g = e(r, p), n.point(g[0], g[1]), n.lineEnd()), r = g;
					else if (a && r && o ^ v) {
						var m;
	...
	function Ie(n) {
		for (var t, r, e, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Xc, d = v.length; d--;)
			if (i = v[d], i && i.prepare())
				for (a = i.edges, c = a.length, o = 0; c > o;) l = a[o].end(), e = l.x, u = l.y, s = a[++o % c].start(), t = s.x, r = s.y, (ca(e - t) > Ca || ca(u - r) > Ca) && (a.splice(o, 0, new Qe(Ge(i.site, l, ca(e - f) < Ca && p - u > Ca ? {
					x: f,
					y: ca(t - f) < Ca ? r : p
				} : ca(u - p) < Ca && h - e > Ca ? {
					x: ca(r - p) < Ca ? t : h,
	...
	function vu(n, t) {
		var r, e, u, i = ns.lastIndex = ts.lastIndex = 0,
			...
			c = [];
		for (n += "", t += "";
			(r = ns.exec(n)) && (e = ts.exec(t));)(u = e.index) > i && (u = t.substring(i, u), a[o] ? a[o] += u : a[++o] = u), (r = r[0]) === (e = e[0]) ? a[o] ? a[o] += e : a[++o] = e : (a[++o] = null, c.push({
			i: o,
			x: pu(r, e)
		})), i = ts.lastIndex;
	...
	function Cu(n, t) {
		var r;
		return arguments.length < 2 && (t = .45), arguments.length ? r = t / Ea * Math.asin(1 / n) : (n = 1, r = t / 4),
			function(e) {
	...
	function Ju(n, t, r) {
		...
		if (n.charge = 0, !n.leaf)
			for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;) i = o[c], null != i && (Ju(i, t, r), n.charge += i.charge, e += i.charge * i.cx, u += i.charge * i.cy);
		if (n.point) {
	...
	function $i(n, t, r) {
		...
		if (r) {
			...
			if (u.shift(), "s" === u[8]) {
				...
				return u[7] || (u[7] = "." + Xi(i.scale(e[2]))), u[8] = "f", r = Bo.format(u.join("")),
					function(n) {
	...
	function bo(n, t) {
		var r = n.length - 1;
		if (r)
			for (var e, u, i = n[0][0], o = n[0][1], a = n[r][0] - i, c = n[r][1] - o, s = -1; ++s <= r;) e = n[s], u = s / r, e[0] = t * e[0] + (1 - t) * (i + u * a), e[1] = t * e[1] + (1 - t) * (o + u * c);
		return xo(n)
	}
	...
	Bo.ascending = n, Bo.descending = function(n, t) {
		...
		if (1 === arguments.length)
			...
			for (; ++o < i;) t(e = r.call(n, n[o], o)) ? u += e : --a;
		return a ? u / a : void 0
	...
	ya.select = function(n) {
		...
		for (var u = -1, i = this.length; ++u < i;)
			for (var o = this[u], a = -1, c = o.length; ++a < c;)(r = o[a]) && (e.push(t = Wo(n.call(r, r.__data__, a, u))), t.parentNode = r);
		return _(e)
	};
	var xa = {
		...
		function t(n, t, u, i, o) {
			return function() {
				...
				var s, l = this,
					...
					y = Y(),
					x = t(h, v);
				e ? (s = e.apply(l, arguments), s = [s.x - x[0], s.y - x[1]]) : s = [0, 0], g({
					type: "dragstart"
				})
			}
		}
	...
	$a.forEach(function(n, t) {
		...
		return r.parse = function(n, t) {
			...
			for (var e, u, i = {}, o = {}, a = [], s = n.length, l = 0, f = 0;
				(e = r()) !== o;) {
	...
	Bo.geo.clipExtent = function() {
		...
		return n.invert = function(n) {
			...
			return r = i.translate(t).clipExtent([
				[l - .455 * s, f - .238 * s],
				[l + .455 * s, f + .238 * s]
			]).stream(c).point, e = o.translate([l - .307 * s, f + .201 * s]).clipExtent([
				...
				if (!isNaN(r) && !isNaN(e))
					if (n.leaf) {
						var c = n.x,
							l = n.y;
						if (null != c)
							if (ca(c - r) + ca(l - e) < .01) s(n, t, r, e, u, i, o, a);
							else {
								var f = n.point;
	...
	Bo.interpolateTransform = Hu, Bo.layout = {}, Bo.layout.bundle = function() {
		...
		return a.tick = function() {
			...
			if (g)
				for (Ju(t = Bo.geom.quadtree(m), e, o), r = -1; ++r < _;)(a = m[r]).fixed || t.visit(n(a));
	...
	Bo.layout.histogram = function() {
		function n(n, i) {
			...
			if (g > 0)
				for (i = -1; ++i < h;) a = s[i], a >= l[0] && a <= l[1] && (o = c[Bo.bisect(f, a, 1, g) - 1], o.y += p, o.push(n[i]));
			return c
		}
		var t = !0,
			r = Number,
		...
		function t(n) {
			for (var t, r = {
				...
				for (var u, i = t.children, o = 0, a = i.length; a > o; ++o) e.push((i[o] = u = {
					_: i[o],
					parent: t,
		...
		function t(r) {
			...
			if (i && i.length) {
				...
				for (n(h, s.dx * s.dy / r.value), l.area = 0;
					(c = h.length) > 0;) l.push(o = h[c - 1]), l.area += o.area, "squarify" !== g || (a = e(l, v)) <= p ? (h.pop(), p = a) : (l.area -= l.pop().area, u(l, v, s, !1), v = Math.min(s.dx, s.dy), l.length = l.area = 0, p = 1 / 0);
